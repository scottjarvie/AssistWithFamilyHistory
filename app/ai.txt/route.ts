...
export function GET() {
  const body = [
    ...
    "Current in production, awaiting joined client proof: family_history_begin_evidence_upload and family_history_finish_evidence_upload accept one checksum-bound JPEG, PNG, or WebP through a short-lived same-origin PUT capability and leave it Private, unreviewed, rights-unknown, and AI-use-off for the person. The isolated B2 storage boundary is provider-proved; no real chosen AI has yet completed upload, person review, later evidence read, and cleanup as one lifecycle.",
