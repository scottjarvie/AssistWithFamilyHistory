# Assist With Family History — FH03-M SVG master study
...
- favicon-mark.svg — transparent favicon drawing, simplified for tiny sizes.
...
The exact source silhouettes are interpreted as clean curves, not traced pixel-for-pixel. Review the visual comparison before claiming final design adoption. FH03-M is the recommended mint/jade application of the preferred FH03, with FH06-M retained. The mint palette is not yet selected by Scott. The nine-person tree is too detailed for dependable 16 px recognition; refine a compact favicon before release.
