# Assist With Family History — brand asset handoff

Delivered locally on 5 September 2026 from the round-six family exploration.

**Current candidate: FH03-M.** FH03-M is the recommended mint/jade application of the preferred FH03, with FH06-M retained. The mint palette is not yet selected by Scott. The nine-person tree is too detailed for dependable 16 px recognition; refine a compact favicon before release.

## What is ready

- `logo-candidate.png`: standalone native-resolution crop of the board candidate, 899 × 818.
- `variants/`: all 2 retained choices with stable IDs.
...
Preview only: compact small-size drawing needed. The 16 px preview is a design check, not proof of a live browser icon.
...
- app/app/source-docs/layout.tsx
